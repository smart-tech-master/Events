...
it('should show the speakers config for an event', async () => {
  ...
  const speakersTitle = 'Welcome to your Speakers'
  ...
  user.click(await findByLabelText('configure speakers'))

  expect(await findByText(speakersTitle)).toBeInTheDocument()
})
